...
- [ ] **Ngày 9 - 10**: *Lecture 2 - Building makemore (Bigram Language Model)* — tóm tắt timestamp + code verbatim từ `karpathy/makemore` (`bigram.py`), NLL loss, Sampling. **→ Mai học (Buổi 9)**
...
- **Đã hoàn thành**: 8 / 35 buổi (22.9%) — đã xong GĐ1 + GĐ2A + micrograd Part 1-2
- **Trạng thái hiện tại**: Tạm dừng — mai tiếp **Buổi 9: makemore Bigram** (Lecture 2) theo plan đã khóa
